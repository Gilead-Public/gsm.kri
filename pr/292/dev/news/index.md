...
- The legacy widget wrappers (`Widget_BarChart`, `Widget_ScatterPlot`,
  ...
  Because these are re-exports, the relocated functions no longer have
  their own reference pages in the gsm.kri documentation site — see the
  gsm.vizr documentation for them.
