...
Mapping, orientation, position, stat, scales, legend, value labels, and
the tooltip formatter – ready to hand to \[gsm.vizr::bars()\].
Click/hover selection is left to the widget's own \`gsm-viz-select\`
event, not a spec callback.
