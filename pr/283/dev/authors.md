...
Source:
[`DESCRIPTION`](https://github.com/Gilead-BioStats/gsm.kri/blob/282-add-the-gsmviz-bundle-update-skill-to-gsmkri/DESCRIPTION)

Wildfire J, Maxwell L, Childress S (2026). *gsm.kri: Good Statistical
Monitoring KRIs*. R package version 1.6.0.9000,
