...
This minor release moves gsm.kri’s interactive charts to gsm.vizr. The
Premature Deaths scatter plots stay on Plotly
([\#120](https://github.com/Gilead-Public/gsm.kri/issues/120)).

**Breaking Changes:**

- Remove `pd_BucketBar()`; use
...
- Require `gsm.qtl (>= 1.4.0)` and add a dependency on
  `gsm.vizr (>= 0.1.0)`.

**Changes:**

- Move the legacy widgets
  ([`Widget_BarChart()`](https://gilead-public.github.io/gsm.vizr/reference/Widget_BarChart.html),
  [`Widget_ScatterPlot()`](https://gilead-public.github.io/gsm.vizr/reference/Widget_ScatterPlot.html),
  [`Widget_TimeSeries()`](https://gilead-public.github.io/gsm.vizr/reference/Widget_TimeSeries.html),
  ...
  to gsm.vizr. gsm.kri re-exports them, so existing code keeps working
  ([\#291](https://github.com/Gilead-Public/gsm.kri/issues/291)).
- Render the Premature Deaths bucket and reason bar charts with
  gsm.vizr, with a built-in count/percent toggle
  ([\#264](https://github.com/Gilead-Public/gsm.kri/issues/264),
  [\#288](https://github.com/Gilead-Public/gsm.kri/issues/288)).
- Render the Eligibility report bar charts with gsm.qtl and fold the
  “Site (by %)” tab into the Site chart’s toggle
  ([\#286](https://github.com/Gilead-Public/gsm.kri/issues/286)).
- Update repository links from Gilead-BioStats to Gilead-Public
