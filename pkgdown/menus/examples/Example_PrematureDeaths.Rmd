...
lListings <- list(
  ...
  # Mapped_EXCLUSION is built in Step 1 from the real enrolled subjects and keyed
  # on real subjid. Step 2b's simulation keeps those real subjids, so the patient
  # listing's eligibility join still matches (mostly Eligible; Unknown only for a
  # subject with no exclusion row).
