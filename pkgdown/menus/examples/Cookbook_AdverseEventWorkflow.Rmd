...
AE_KRI <- workr::RunWorkflow(lWorkflow = AE_workflow, lData = AE_data)
...
AE_country_KRI <- workr::RunWorkflow(lWorkflow = AE_country_workflow, lData = AE_data)
```
...
SAE_KRI <- workr::RunWorkflow(lWorkflow = SAE_workflow, lData = AE_data)
```
