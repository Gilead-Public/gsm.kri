...
Milestone: [v2.0.0](https://github.com/Gilead-Public/gsm.kri/milestone/18)
...
- [ ] Build site `pkgdown::build_site()` and check that all affected examples are displayed correctly and that all new functions occur on the "[Reference](https://gilead-public.github.io/gsm.kri/reference/index.html)" page. 
