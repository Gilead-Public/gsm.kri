    ...
    Output
      List of 17
       ...
       $ Analysis_kri0013:List of 6
        ...
        ..$ bDebug     : logi FALSE
       $ Analysis_kri0014:List of 6
        ..$ dfResults  : int 4841
        ..$ dfBounds   : int 32721
        ..$ dfGroups   : int 1665
        ..$ dfMetrics  : int 17
        ..$ strMetricID: chr "Analysis_kri0014"
        ..$ bDebug     : logi FALSE
       $ Analysis_kri0015:List of 6
        ..$ dfResults  : int 4841
        ..$ dfBounds   : int 32721
        ..$ dfGroups   : int 1665
        ..$ dfMetrics  : int 17
        ..$ strMetricID: chr "Analysis_kri0015"
        ..$ bDebug     : logi FALSE
       $ Analysis_kri0016:List of 6
        ..$ dfResults  : int 4841
        ..$ dfBounds   : int 32721
        ..$ dfGroups   : int 1665
        ..$ dfMetrics  : int 17
        ..$ strMetricID: chr "Analysis_kri0016"
        ..$ bDebug     : logi FALSE
       $ Analysis_srs0001:List of 6
        ..$ dfResults  : int 4841
        ..$ dfBounds   : int 32721
        ..$ dfGroups   : int 1665
        ..$ dfMetrics  : int 17
        ..$ strMetricID: chr "Analysis_srs0001"
        ..$ bDebug     : logi FALSE
